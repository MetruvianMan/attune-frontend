...
const DEFAULT_BUTTONS: QuickTapButton[] = [
  ...
  { id: 'default-good-breakfast', eventType: 'good_breakfast', label: 'Good Breakfast', order: 19 },
  { id: 'default-tired', eventType: 'tired', label: 'Tired', order: 20 },
  { id: 'default-fast-food', eventType: 'fast_food', label: 'Fast Food', order: 21 },
  { id: 'default-sports', eventType: 'sports', label: 'Sports', order: 22 },
  { id: 'default-party', eventType: 'party', label: 'Party', order: 23 },
  { id: 'default-bounceback', eventType: 'bounceback', label: 'Bounceback', order: 24 },
  { id: 'default-sugar', eventType: 'sugar', label: 'Sugar', order: 25 },
  { id: 'default-poor-transitions', eventType: 'poor_transitions', label: 'Poor Transitions', order: 26 },
  { id: 'default-chores', eventType: 'chores', label: 'Chores', order: 27 },
  { id: 'default-focus', eventType: 'focus', label: 'Focus', order: 28 },
  { id: 'default-reading', eventType: 'reading', label: 'Reading', order: 29 },
  { id: 'default-kindness', eventType: 'kindness', label: 'Kindness', order: 30 },
  { id: 'default-overwhelm', eventType: 'overwhelm', label: 'Overwhelm', order: 31 },
  { id: 'default-naughty', eventType: 'naughty', label: 'Naughty', order: 32 },
  { id: 'default-refusal', eventType: 'refusal', label: 'Refusal', order: 33 },
  { id: 'default-sibling-harmony', eventType: 'sibling_harmony', label: 'Sibling Harmony', order: 34 },
  { id: 'default-bad-language', eventType: 'bad_language', label: 'Bad Language', order: 35 },
  { id: 'default-injury', eventType: 'injury', label: 'Injury', order: 36 },
  { id: 'default-sneaky', eventType: 'sneaky', label: 'Sneaky', order: 37 },
  { id: 'default-messy', eventType: 'messy', label: 'Messy', order: 38 },
  { id: 'default-helpful', eventType: 'helpful', label: 'Helpful', order: 39 },
  { id: 'default-video-games', eventType: 'video_games', label: 'Video Games', order: 40 },
  { id: 'default-toilet-issue', eventType: 'toilet_issue', label: 'Toilet Issue', order: 41 },
  { id: 'default-dad-bonding', eventType: 'dad_bonding', label: 'Dad Bonding', order: 42 },
  { id: 'default-mom-bonding', eventType: 'mom_bonding', label: 'Mom Bonding', order: 43 },
  { id: 'default-travel', eventType: 'travel', label: 'Travel', order: 44 },
];
